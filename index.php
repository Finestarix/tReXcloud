            ...
            <nav class="relative flex items-center justify-between sm:h-10 md:justify-center">
                <div class="flex items-center flex-1 md:absolute md:inset-y-0 md:left-0">
                    <div class="flex items-center justify-between w-full md:w-auto">
                        <a href="/index.php">
                            <img class="h-8 w-auto sm:h-10" src="/public/logo/logo-text.png" alt="Logo">
                        </a>
        ...
        <div class="absolute top-0 inset-x-0 p-2 transition transform origin-top-right md:hidden"
            ...
            <div class="rounded-lg shadow-md bg-white ring-1 ring-black ring-opacity-5 overflow-hidden">
                <div class="px-5 pt-4 flex items-center justify-between">
                    <div>
                        <img class="h-8 w-auto" src="/public/logo/logo.png" alt="Logo">
                    </div>
                    <div class="-mr-2">
                        <button type="button"
    ...
    <div id="company" class="py-14 px-4 sm:py-20 sm:px-6 lg:px-8 mx-auto max-w-7xl bg-green-50">
        <div class="lg:grid lg:grid-cols-2 lg:gap-8">
            <h2 class="max-w-md mx-auto text-3xl font-extrabold text-green-600 text-center lg:max-w-xl lg:text-left">
                The world's most innovative companies use ReXcloud
            </h2>
        ...
        <div class="max-w-7xl mx-auto py-8 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
            ...
            <div class="mt-8 md:mt-0 md:order-1">
                <p class="text-center text-base text-gray-500">
                    &copy; 2022 ReXcloud - New Assistant Recuitment (NAR) 22-2.
                </p>
                <p class="text-center text-base text-gray-400">
                    Inspired by <a href="https://workspace.google.com/intl/en/products/drive">Google Drive</a> & <a
                            href="https://mega.io">MEGA</a>.
                </p>
                <p class="text-center text-base text-gray-400">
