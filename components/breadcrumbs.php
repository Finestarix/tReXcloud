...
<div class="mt-4"
     x-data="{isRenameModalOpen: false}">
                    ...
                    <div class="ml-1 relative inline-block text-left"
                        ...
                        <div>
                            <button type="button"
                                ...
                                <?= (strlen($splitPath[$totalPath - 1]) > 10 ? substr($splitPath[$totalPath - 1], 0, 10) . "..." : $splitPath[$totalPath - 1]) ?>
                                <svg class="-mr-1 h-5 w-5" xmlns="http://www.w3.org/2000/svg"
                                     viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
                                    <path fill-rule="evenodd" clip-rule="evenodd"
                                          d="M5.293 7.293a1 1 0 011.414 0L10 10.586l3.293-3.293a1 1 0 111.414 1.414l-4 4a1 1 0 01-1.414 0l-4-4a1 1 0 010-1.414z"/>
                            ...
                            <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                ...
                                <div class="mt-2">
                                    <form id="rename-form" action="controllers/fileController.php" method="POST">
                                        ...
                                        <input id="directory" name="directory" type="hidden" value="<?= $splitPath[$totalPath - 1] ?>">
                                        <input type="text" name="newDirectory" id="newDirectory" value="<?= $splitPath[$totalPath - 1] ?>" autofocus
